...
function make_mail_body(docs,models,bins){
  var temp = docs.filter(function(obj){
    return models.includes(obj.model) && bins.includes(obj.fq_bin);
  });
...
module.exports.sendMail = function(subject,docs,models,bins){
  var mailOptions = {
    from: config.MAIL_FROM,
    to: config.MAIL_TO,
    subject: subject,
    html: make_mail_body(docs,models,bins)
  };
